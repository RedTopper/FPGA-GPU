...
## sgp_system.tcl
########################################################################
## DESCRIPTION: This file contains the tcl project file for MP-1. Run
## this file via Vivado via the "source <path>/sgp_system.tcl" command. 
##
## NOTES:
...
set _xil_proj_name_ "sgp_system"
...
set script_file "sgp_system.tcl"
...
create_project ${_xil_proj_name_} "$origin_dir/" -force -part xc7a200tsbg484-1
...
#set obj [get_filesets sources_1]
#set files [list \
# [file normalize "${origin_dir}/sgp_system.srcs/sources_1/bd/design_1/design_1.bd"] \
# [file normalize "${origin_dir}/sgp_system.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"] \
#]
#add_files -norecurse -fileset $obj $files

# Add local files from the original project (-no_copy_sources specified)
#set files [list \
# [file normalize "${origin_dir}/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_mig_7series_0_0/mig_a.prj" ]\
# [file normalize "${origin_dir}/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_mig_7series_0_0/mig_b.prj" ]\
#]
#set added_files [add_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
#set file "$origin_dir/sgp_system.srcs/sources_1/bd/design_1/design_1.bd"
...
set file "[file normalize ${origin_dir}/../constrs/NexysVideo_Master.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constrs/NexysVideo_Master.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/../constrs/axis_async_fifo.tcl]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constrs/axis_async_fifo.tcl"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "TCL" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/../constrs/eth_mac_1g_rgmii.tcl]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constrs/eth_mac_1g_rgmii.tcl"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "TCL" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/../constrs/eth_mac_fifo.tcl]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constrs/eth_mac_fifo.tcl"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "TCL" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/../constrs/rgmii_phy_if.tcl]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constrs/rgmii_phy_if.tcl"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "TCL" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/../constrs/sync_reset.tcl]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constrs/sync_reset.tcl"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "TCL" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/../constrs/vdma_timing_workaround.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constrs/vdma_timing_workaround.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a200tsbg484-1 -flow {Vivado Synthesis 2020} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a200tsbg484-1 -flow {Vivado Implementation 2020} -strategy "Performance_ExplorePostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
# JAZ. Create block design
source $origin_dir/design_1.tcl

# JAZ. Generate the wrapper
