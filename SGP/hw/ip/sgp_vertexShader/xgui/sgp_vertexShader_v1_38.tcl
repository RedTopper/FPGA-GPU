...
proc update_PARAM_VALUE.C_NUM_VERTEX_ATTRIB { PARAM_VALUE.C_NUM_VERTEX_ATTRIB } {
	# Procedure called to update C_NUM_VERTEX_ATTRIB when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_NUM_VERTEX_ATTRIB { PARAM_VALUE.C_NUM_VERTEX_ATTRIB } {
	# Procedure called to validate C_NUM_VERTEX_ATTRIB
	return true
}
...
proc update_MODELPARAM_VALUE.C_NUM_VERTEX_ATTRIB { MODELPARAM_VALUE.C_NUM_VERTEX_ATTRIB PARAM_VALUE.C_NUM_VERTEX_ATTRIB } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_NUM_VERTEX_ATTRIB}] ${MODELPARAM_VALUE.C_NUM_VERTEX_ATTRIB}
}
