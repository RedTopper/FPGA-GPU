...
int main( void )
{
	...
	GLuint programID = LoadShaders( "../common/shaders/ogldir1/NormalMapping.vert", "../common/shaders/ogldir1/NormalMapping.frag" );
	...
	// Load the texture
	GLuint DiffuseTexture = loadDDS("../common/images/textures/diffuse.DDS");
	GLuint NormalTexture = loadBMP_custom("../common/images/textures/normal.bmp");
	GLuint SpecularTexture = loadDDS("../common/images/textures/specular.DDS");
