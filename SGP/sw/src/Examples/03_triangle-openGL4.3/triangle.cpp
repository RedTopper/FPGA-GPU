...
{
	TriangleShader.init();
	TriangleShader.attach(GL_VERTEX_SHADER, "../common/shaders/ogldir2/triangle.vert");
	TriangleShader.attach(GL_FRAGMENT_SHADER, "../common/shaders/ogldir2/triangle.frag");
	TriangleShader.link();
